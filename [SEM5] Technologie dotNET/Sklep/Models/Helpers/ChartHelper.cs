...
namespace Sklep.Models.Helpers
{
    public static class ChartHelper
    {
        public static HtmlString Chart(this HtmlHelper helper, string chartName, List<object[]> dataSource, string xTitle, string Ytitle )
        {
            return SetupHtml(chartName, GetDataSourceFromArray(dataSource), xTitle, Ytitle);
        }

        private static string GetDataSourceFromArray(List<object[]> dataSource)
        {
